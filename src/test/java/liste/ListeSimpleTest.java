...
public class ListeSimpleTest {
    ...
    @Test
    public void testGetSizeApresAjoutsEtSuppression() {
        listeATester.ajout(1);
        listeATester.ajout(2);
        listeATester.ajout(3);
        assertEquals(3, listeATester.getSize());
    ...
    @Test
    public void testAjoutDeValeursDifferentes() {
        listeATester.ajout(1);
        listeATester.ajout(2);
        listeATester.ajout(3);
        assertEquals(3, listeATester.getSize());
    ...
    @Test
    public void testModifieTousSansElement() {
        listeATester.ajout(1);
        listeATester.ajout(2);
        listeATester.modifieTous(3, 4);
        assertEquals(listeATester.toString(), "ListeSimple(Noeud(2), Noeud(1))");
    }

    @Test
    public void testSupprimeTousSansElement() {
        listeATester.ajout(1);
        listeATester.ajout(2);
        listeATester.supprimeTous(3);
        assertEquals(listeATester.toString(), "ListeSimple(Noeud(2), Noeud(1))");
    ...
    @Test
    public void testEchangeNoeudsNonAdjacents() {
        listeATester.ajout(1);
        listeATester.ajout(2);
        listeATester.ajout(3);
        listeATester.ajout(4);
        ...
        listeATester.echanger(r1, r2);
        assertEquals(listeATester.toString(), "ListeSimple(Noeud(2), Noeud(1), Noeud(4), Noeud(3))");
    }

    @Test
    public void testEchangePremierEtDernierNoeud() {
        listeATester.ajout(1);
        listeATester.ajout(2);
        listeATester.ajout(3);
        Noeud r1 = listeATester.tete;
        ...
        listeATester.echanger(r1, r2);
        assertEquals(listeATester.toString(), "ListeSimple(Noeud(1), Noeud(3), Noeud(2))");
    }
