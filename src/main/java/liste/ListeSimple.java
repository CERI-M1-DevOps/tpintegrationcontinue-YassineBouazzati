...
public class ListeSimple {
    ...
    /**
     * Modifie toutes les occurrences d'un élément donné avec une nouvelle valeur.
     * @param element l'élément à rechercher.
     * @param nouvelleValeur la nouvelle valeur pour remplacer chaque occurrence de l'élément.
     */
